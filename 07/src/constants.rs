...
pub const INITIAL_HASH: Hash = Hash {
	a: Word { value: 0x6a09e667 },
	b: Word { value: 0xbb67ae85 }, 
	c: Word { value: 0x3c6ef372 }, 
	d: Word { value: 0xa54ff53a },
    e: Word { value: 0x510e527f },
    f: Word { value: 0x9b05688c }, 
    g: Word { value: 0x1f83d9ab },
    h: Word { value: 0x5be0cd19 }
};
